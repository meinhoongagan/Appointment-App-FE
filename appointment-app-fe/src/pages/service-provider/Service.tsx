  ...
  return (
    <ErrorBoundary>
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 flex flex-col">
        ...
        {/* Header */}
        <header className="bg-white shadow-lg py-4 fixed w-full z-40">
          <div className="container mx-auto px-6 flex justify-between items-center">
            ...
            <nav className="hidden md:flex items-center space-x-8">
              <Link to="/service-dashboard" className="font-medium text-gray-700 hover:text-pink-500 transition-colors">Dashboard</Link>
              <Link to="/service-dashboard/appointments" className="font-medium text-gray-700 hover:text-pink-500 transition-colors">Appointments</Link>
              <Link to="/service-dashboard/services" className="font-medium text-pink-500 border-b-2 border-pink-500 pb-1">Services</Link>
              <Link to="/service-dashboard/profile" className="font-medium text-gray-700 hover:text-pink-500 transition-colors">Profile</Link>
              <button 
          ...
          {mobileMenuOpen && (
            <div className="md:hidden bg-white shadow-xl px-4 py-5 absolute top-full left-0 right-0 border-t border-gray-100">
              <nav className="flex flex-col space-y-4">
                <Link to="/service-dashboard" className="text-gray-700 hover:text-pink-500 transition-colors font-medium" onClick={() => setMobileMenuOpen(false)}>Dashboard</Link>
                <Link to="/service-dashboard/appointments" className="text-gray-700 hover:text-pink-500 transition-colors font-medium" onClick={() => setMobileMenuOpen(false)}>Appointments</Link>
                <Link to="/service-dashboard/services" className="text-pink-500 font-medium" onClick={() => setMobileMenuOpen(false)}>Services</Link>
                <Link to="/service-dashboard/profile" className="text-gray-700 hover:text-pink-500 transition-colors font-medium" onClick={() => setMobileMenuOpen(false)}>Profile</Link>
                <button onClick={() => { handleLogout(); setMobileMenuOpen(false); }} className="text-gray-700 hover:text-pink-500 transition-colors font-medium text-left">Logout</button>
              </nav>
            </div>
          )}
        </header>
