...
const ConsumerLayout = () => {
  ...
  const navigation = [
    ...
    { name: "Find Services", href: "/consumer-dashboard/find-services", icon: Search },
    { name: "My Appointments", href: "/consumer-dashboard/appointments", icon: Calendar },
    { name: "Profile", href: "/consumer-dashboard/profile", icon: User },
  ];
